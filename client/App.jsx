    ...
    const SessionsTable = () => {
        return (
            <div className="p-6 border border-gray-200 rounded-xl bg-white shadow-md">
                ...
                <p className="text-sm text-gray-500 mb-3">{sessionMessage}</p>
                ...
                <button 
                    ...
                    className="mt-4 px-3 py-1 text-xs bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition"
                >
                    Refresh List
                </button>
            </div>
